...
class JsonEncoderSpec extends WordSpec with MustMatchers {
  ...
  "JsonEncoder" should {
    ...
    "encode case classes" in {
      ...
      Car("Aston Martin", "DB5", 1964).toJsonString mustBe """["Aston Martin", "DB5", 1964]"""
      Car("Fiat", "126P", 1975).toJsonString mustBe """["Fiat", "126P", 1975]"""
    }

    "encode tuples"   in {

      (true, "Test", 10.5).toJsonString mustBe """[true, "Test", 10.5]"""
      (42, false).toJsonString mustBe """[42, false]"""
    }
  }
